...
class CNNbLSTMCRF:
    ...
    def build(self, data_full, outputs,
        ...
        l_dp = keras.layers.Dropout(dense_dropout)(l_bi)
        l_de = TimeDistributed(Dense(dense_dim, activation='relu'))(l_dp)
        l_pn = keras.layers.Dropout(dense_dropout)(l_de)
        ...
        for name, w, ltype in outputs:
            ...
            l_crf = CRF(n_out, learn_mode='marginal', test_mode='marginal', name=yname)(l_pn)
            l_outputs.append(l_crf)
